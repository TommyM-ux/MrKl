    ...
    function generate() {
      ...
      $('out').innerHTML = `
        ...
        <div id="fullText">
          ...
          <p>Dále <strong>${armDec}×</strong> opakujte: 1 řada rovně, 1 řada ujmout 1 oko na každém konci. Zůstane <strong>${armRemain} ok</strong>. Výška průramku: cca <strong>${armRows} řad</strong>.</p>
